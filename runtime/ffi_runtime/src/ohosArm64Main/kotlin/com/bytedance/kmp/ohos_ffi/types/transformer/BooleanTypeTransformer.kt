...
object BooleanTypeTransformer : ArkTsExportCustomTransformer<Boolean> {
    override fun fromJsObject(value: napi_value): Boolean {
        return value.asBoolean()
    }

    override fun toJsObject(value: Boolean): napi_value {
