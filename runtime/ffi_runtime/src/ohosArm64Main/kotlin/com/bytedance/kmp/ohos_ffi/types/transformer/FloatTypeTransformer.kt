...
object FloatTypeTransformer : ArkTsExportCustomTransformer<Float> {
    override fun fromJsObject(value: napi_value): Float {
        return value.asDouble().toFloat()
    }

    override fun toJsObject(value: Float): napi_value {
        return createDouble(value.toDouble())
    }
}