...
object DoubleTypeTransformer : ArkTsExportCustomTransformer<Double> {
    override fun fromJsObject(value: napi_value): Double {
        return value.asDouble()
    }

    override fun toJsObject(value: Double): napi_value {
