...
object StringTypeTransformer : ArkTsExportCustomTransformer<String> {
    override fun fromJsObject(value: napi_value): String {
        return value.asString()
    }

    override fun toJsObject(value: String): napi_value {
