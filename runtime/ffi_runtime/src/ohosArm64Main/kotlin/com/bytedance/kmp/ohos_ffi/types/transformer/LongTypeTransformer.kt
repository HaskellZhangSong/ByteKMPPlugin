...
object LongTypeTransformer : ArkTsExportCustomTransformer<Long> {
    override fun fromJsObject(value: napi_value): Long {
        return value.asLong()
    }

    override fun toJsObject(value: Long): napi_value {
